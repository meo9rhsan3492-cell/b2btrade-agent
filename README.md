...
| 📋 **报关顾问** | HS编码、退税、贸易条款 |
| 🤝 **谈判专家** | 价格谈判、合同条款、风险控制 |
| 💼 **LinkedIn 外展** | 个人主页抓取 + 个性化连接请求/私信草稿 |
| 💬 **WhatsApp 外展** | 多语言消息生成（中/英/阿/西/法），批量模板 |
| 📧 **Email 外展** | 开发信/跟进邮件/报价邮件，HTML格式支持 |
| 🛒 **Shopify 助手** | 订单处理、发货通知、询盘响应 |
| 🏭 **Ali1688 助手** | 商品搜索、供应商信息、价格对比 |
| 📺 **TikTok 助手** | 商品列表、订单处理、产品描述生成 |
| 📸 **Instagram 助手** | 商业主页数据、图片描述、推广文案 |
| 💰 **财务顾问** | 外汇结算、信用证、收汇保障 |
